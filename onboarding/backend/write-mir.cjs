 ...
 *
 * @param {string} mirPath  — absolute path to the .mgsd-local/MIR directory
  ...
  for (const [section, content] of Object.entries(approvedDrafts)) {
    ...
    try {
      ...
      if (existingText) {
        ...
        if (!existingText.includes('Generated by MGSD AI')) {
 ...
 *
 * @param {string} statePath  — absolute path to .mgsd-local/MIR/STATE.md
