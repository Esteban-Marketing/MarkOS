...
}`,...(q=(C=l.parameters)==null?void 0:C.docs)==null?void 0:q.source},description:{story:"Filled: 8 of 10 seats used — `.meterFill--warning` state (70–90% per UI-SPEC AC M-2).",...(S=(F=l.parameters)==null?void 0:F.docs)==null?void 0:S.description}}};var E,M,T,V,P;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    ...baseArgs,
    members: sampleMembers,
    pendingInvites: [{
...
}`,...(T=(M=c.parameters)==null?void 0:M.docs)==null?void 0:T.source},description:{story:"InvitePending: `.c-notice c-notice--info` banner + pending invite table row with `.c-badge--info` glyph (M-3, M-4).",...(P=(V=c.parameters)==null?void 0:V.docs)==null?void 0:P.description}}};var k,A,$,O,U;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    ...baseArgs,
    members: sampleMembers,
    pendingInvites: [],
...
}`,...($=(A=d.parameters)==null?void 0:A.docs)==null?void 0:$.source},description:{story:"RoleEdit: shows how the role select `.c-input` renders in the invite form; seat bar at error state (>=90%).",...(U=(O=d.parameters)==null?void 0:O.docs)==null?void 0:U.description}}};var Z,B,D,L,J;m.parameters={...m.parameters,docs:{...(Z=m.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
    ...baseArgs,
    members: [],
    pendingInvites: [],
