...
module.exports = async function handler(req, res) {
  ...
  const syncOutcome = deriveProviderSyncOutcome({ line_items: reconciled.line_items, provider: 'stripe', sync_status: 'succeeded' });
  ...
  return writeJson(res, 200, {
    ...
    hold: syncOutcome.billing_state === 'hold' ? syncOutcome : null,
    evidence: {
