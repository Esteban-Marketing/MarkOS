...
| Date | Platform | Format | Pillar | Title / Topic | Status | Campaign Link |
|------|---------|--------|--------|--------------|--------|--------------|
| [YYYY-MM-DD] | [Platform] | [Format] | [C1–C4] | [FILL] | [PLANNED / IN-PROGRESS / PUBLISHED] | [Campaign ID or N/A] |

---

## Current Month: [YYYY-MM]

| Date | Platform | Format | Pillar | Title / Topic | Status | Notes |
|------|---------|--------|--------|--------------|--------|-------|
| | | | | | | |

---

## Upcoming Month: [YYYY-MM]
...
> Content that can be published at any time, not tied to a specific date.

| Format | Pillar | Title / Topic | Status |
|--------|--------|--------------|--------|
| [FILL] | [FILL] | [FILL] | [READY / DRAFT] |