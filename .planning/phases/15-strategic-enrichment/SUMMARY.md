...
- created: 
  ...
  - `.markos-local/MSP/*/WINNERS/_CATALOG.md`
- modified:
  - `.agent/markos/agents/markos-executor.md`
...
- **Local Sovereignty:** Placed "Winners" catalogs in `.markos-local/` to ensure client data remains private while the protocol remains generic.
