...
> **Phase 201.1 scope claim (revision iter 2):** closes **6 HIGH + 6 MEDIUM** (1 deferred — M1 passkey challenge binding deferred to Phase 201.2 / 202+; see `201.1-CONTEXT.md` `<deferred>` and RESEARCH §M1).
