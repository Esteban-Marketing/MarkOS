...
- **LITX-01**: Semantic concept graph inference across vault artifacts.
- **LITX-02**: Automated contradiction detection with guided remediation suggestions.

### Ecosystem Expansion

- **LITX-03**: Cross-workspace vault federation with policy-scoped sharing.
- **LITX-04**: External BI export contracts for reporting stacks.

## Out of Scope

| Feature | Reason |
|---------|--------|
| Full CRM/outbound feature expansion | Not core to vault-first literacy milestone scope |
| Autonomous publish with no human approval | Violates governance and quality guardrails |
| Major platform re-architecture | Milestone must remain additive to existing architecture |
