...
```bash
cp ".github/get-shit-done/USER-PROFILE.md" ".github/get-shit-done/USER-PROFILE.backup.md"
```
...
- options (ALL pre-selected by default):
  ...
  - "copilot-instructions.md profile section" -- "Add profile to this project's root copilot-instructions.md contract"
  - "Global copilot-instructions.md" -- "Add profile to the hidden shared-framework copilot-instructions.md artifact for all projects"
...
Display: "✓ Added profile section to the project-root copilot-instructions.md"
...
Display: "✓ Added profile section to the hidden shared-framework copilot-instructions artifact"
...
```bash
BACKUP_PATH=".github/get-shit-done/USER-PROFILE.backup.md"
```
...
Artifacts:
  ...
  ✓ Global copilot-instructions.md        hidden shared-framework artifact
```
