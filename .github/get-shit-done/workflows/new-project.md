...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE="copilot-instructions.md"; fi  # project-root shared contract; distinct from hidden shared-framework instructions
```
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, project-root `copilot-instructions.md` for the shared .github surface on all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, project-root copilot-instructions.md otherwise)
