...
**Project instructions:** Read ./copilot-instructions.md if exists — follow project-specific guidelines for the shared .github surface; do not substitute the hidden shared-framework instructions artifact.
...
**Project instructions:** Read ./copilot-instructions.md if exists — verify plans honor the shared .github project-root contract rather than the hidden shared-framework artifact.
