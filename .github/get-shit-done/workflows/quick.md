...
- ./copilot-instructions.md (if exists — project-root contract for the shared .github surface)
...
- ./copilot-instructions.md (if exists — follow project-root guidance for the shared .github surface)
...
- .planning/STATE.md (Project state)
- ./copilot-instructions.md (Project-root instructions for the shared .github surface, if it exists)
