...
<project_contract>
For this shared `.github` workflow, treat root `./copilot-instructions.md` as the project instruction contract. Root `CLAUDE.md` may exist as a sibling localized runtime contract, but it does not replace the shared surface contract here.
</project_contract>
