   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Task(
     ...
     prompt="
       ...
       ` : ''}
      - ./copilot-instructions.md (Project-root instructions for the shared .github surface, if they exist — follow project-specific guidelines and coding conventions)
