...
This is the shared GSD and Copilot contract in the dual-root instruction policy; root `CLAUDE.md` remains the localized Claude runtime contract.
...
**Discovery behavior:**
- Scans `.github/skills/`, `.agents/skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
...
copilot-instructions.md file in the shared contract lane; root `CLAUDE.md` remains the sibling localized contract.
