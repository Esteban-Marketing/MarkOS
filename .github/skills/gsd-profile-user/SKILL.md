...
<objective>
Generate a developer behavioral profile from session analysis (or questionnaire) and produce artifacts (USER-PROFILE.md, /gsd-dev-preferences, project-root copilot-instructions.md section, optional shared-framework global artifact section) that personalize the agent's responses.
...
8. Artifact selection (dev-preferences, project-root and shared-framework copilot-instructions.md sections)
