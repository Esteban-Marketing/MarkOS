...
**Project instructions:** Read `./copilot-instructions.md` if it exists in the working directory. Follow all project-specific guidelines. Treat it as the project-root contract for the shared `.github` surface, not as a substitute for any hidden shared-framework artifact.
