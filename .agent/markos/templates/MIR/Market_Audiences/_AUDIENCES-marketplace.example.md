...
* **Independent Graphic Designers (Core):** 2–8 years of experience, primarily self-taught or design school graduates, freelancing as their primary income ($45K–$90K/yr). They join the platform to replace unpredictable client referrals with consistent inbound.
* **Established Creative Studios (Growth):** Small studios (2–5 people) looking to fill capacity gaps between anchor clients. Higher average project value, more selective about project types.
...
* **Marketing Teams at Growth-Stage Startups (Primary):** 20–200 person companies with a 2–5 person marketing team. They have recurring creative needs (ad creatives, social assets, pitch decks) but cannot justify a full-time designer hire.
