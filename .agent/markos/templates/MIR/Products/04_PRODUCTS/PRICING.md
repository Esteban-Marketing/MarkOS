...
<!-- markos-token: MIR -->
> [!NOTE] OVERRIDE PATH: Copy this file to `.markos-local/MIR/Products/04_PRODUCTS/PRICING.md` to customize it safely.

> [!IMPORTANT]
> **AGENT LOGIC**: This file is the absolute source of truth for all financial claims. `markos-auditor` MUST flag any ad copy or landing page that contradicts the price points or billing terms listed here. `markos-copy-drafter` MUST consult Section 6 before stating any prices in public-facing copy.
