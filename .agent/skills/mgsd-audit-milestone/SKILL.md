...
<execution_context>
@.agent/marketing-get-shit-done/workflows/audit-milestone.md
</execution_context>

<process>
Execute the `/mgsd-audit-milestone` workflow as documented.
</process>
