<!-- TODO: workflow file .agent/get-shit-done/workflows/analyze-dependencies.md not yet ported from upstream GSD; skill will fail to resolve execution_context until ported. -->
---
