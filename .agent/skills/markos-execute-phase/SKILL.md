...
<execution_context>
@.agent/markos/workflows/execute-phase.md
</execution_context>

<process>
Execute the `/markos-execute-phase` workflow exactly as documented in the workflow file.
</process>
