...
# markos-research-phase

<context>
Spawns markos-market-researcher to produce RESEARCH.md for the specified phase. Use before /markos-plan-phase when deeper channel or competitive research is needed.
</context>

<execution_context>
@.agent/markos/workflows/research-phase.md
</execution_context>

<process>
Execute the `/markos-research-phase` workflow exactly as documented in the workflow file.
</process>
