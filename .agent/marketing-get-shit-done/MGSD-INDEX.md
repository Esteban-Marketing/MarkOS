...
|----------|-----------|-------|--------|-------------|
| MGSD-IDX-000 | `MGSD-INDEX.md` | IDX | OPS | This file. Master entry point for all autonomous agents. |
...
| TOKEN_ID | File Path | Class | Domain | Description |
|----------|-----------|-------|--------|-------------|
| MGSD-REF-NEU-01 | `references/neuromarketing.md` | REF | NEU | B01–B10 biological trigger catalog, archetype→ICP map, funnel stage→trigger assignments, `<neuro_spec>` block schema |
| MGSD-REF-OPS-01 | `references/mir-gates.md` | REF | OPS | Gate 1 (Identity) and Gate 2 (Execution) file requirements, check logic, agent enforcement table |
| MGSD-REF-OPS-02 | `references/marketing-living-system.md` | REF | OPS | Protocol-level audit, cross-protocol gap register (GAP-01–GAP-07), enhancement roadmap |
| MGSD-REF-OPS-03 | `references/verification-patterns.md` | REF | OPS | Standard verification patterns used by verifier and checker agents |
| MGSD-REF-OPS-04 | `references/questioning.md` | REF | OPS | Adaptive questioning protocol used by discuss-phase skill |
| MGSD-REF-OPS-05 | `references/planning-config.md` | REF | OPS | .planning/config.json schema and field definitions |
| MGSD-REF-OPS-06 | `references/continuation-format.md` | REF | OPS | Resume/continuation handoff format standard |
| MGSD-REF-OPS-07 | `references/checkpoints.md` | REF | OPS | Checkpoint pattern for mid-phase human handoff |
| MGSD-REF-OPS-08 | `references/user-profiling.md` | REF | OPS | User behavioral profile schema |
| MGSD-REF-OPS-09 | `references/model-profiles.md` | REF | OPS | Model profile definitions (quality/balanced/budget/inherit) |
| MGSD-REF-OPS-10 | `references/model-profile-resolution.md` | REF | OPS | Profile resolution logic for agent invocation |
| MGSD-REF-OPS-11 | `references/decimal-phase-calculation.md` | REF | OPS | Decimal phase numbering algorithm (e.g., 2.1 between phase 2 and 3) |
| MGSD-REF-OPS-12 | `references/phase-argument-parsing.md` | REF | OPS | Argument parsing rules for phase-targeting skills |
| MGSD-REF-OPS-13 | `references/git-integration.md` | REF | OPS | Git commit patterns, branch strategy for MGSD |
| MGSD-REF-OPS-14 | `references/git-planning-commit.md` | REF | OPS | .planning/ directory commit conventions |
| MGSD-REF-CNT-01 | `references/ui-brand.md` | REF | CNT | UI brand guidelines for MGSD output formatting |
