...
// Phase 201.1 D-108: staging smoke #01 — Wildcard DNS + Vercel Domains BYOD end-to-end.
...
async function runDry(_opts) {
  return { ok: true, message: 'dry-run mock pass: wildcard DNS shape verified', latency_ms: 1 };
}

async function runLive(_opts) {
  // STUB: live-mode body filled in during v4.0.0-release prep.
  // Reference: Vercel Domains API; node-fetch DNS resolver; LetsEncrypt cert verifier.
  return {
    ok: false,
    skipped: true,
