...
This is the localized Claude runtime contract in the dual-root instruction policy; root `copilot-instructions.md` remains the shared GSD and Copilot contract.
...
CLAUDE.md file in the localized runtime lane; root `copilot-instructions.md` remains the sibling shared contract.
