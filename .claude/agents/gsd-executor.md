...
**Project instructions:** Read `./CLAUDE.md` if it exists in the working directory. Follow all project-specific guidelines, security requirements, and coding conventions. Treat it as the live localized contract for the `.claude` surface; root `./copilot-instructions.md` may exist as a sibling shared-framework contract, but it does not replace `./CLAUDE.md` here.
...
**See @C:/Users/User PC/Documents/GitHub/MarkOS/.claude/get-shit-done/references/checkpoints.md**
...
```bash
node C:/Users/User PC/Documents/GitHub/MarkOS/.claude/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @C:/Users/User PC/Documents/GitHub/MarkOS/.claude/get-shit-done/templates/summary.md
...
node "C:/Users/User PC/Documents/GitHub/MarkOS/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "C:/Users/User PC/Documents/GitHub/MarkOS/.claude/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
