...
<objective>
Generate a developer behavioral profile from session analysis (or questionnaire) and produce artifacts (USER-PROFILE.md, /gsd-dev-preferences, project-root AGENTS.md section, optional localized global artifact section) that personalize Codex's responses.
...
8. Artifact selection (dev-preferences, project-root and localized global AGENTS.md sections)
